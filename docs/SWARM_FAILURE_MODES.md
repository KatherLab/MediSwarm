...
- **Observed 2026-09-14:** four clients on dl3, one stopped in round 2; run `mvp4_local_260914_1429`. Acceptance test for the fix: the same injection, six rounds complete with the three survivors.

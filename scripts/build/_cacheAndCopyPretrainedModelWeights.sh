...
MODEL_WEIGHTS_FILE_SAMMED2D_HASH=921d8c130cc4bcc4b7220c064e60f207f15ad59f17ab36de340e41c67a490d18
...
MODEL_WEIGHTS_FILE_RESNETEIGHTEEN=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet18/blobs/'$MODEL_WEIGHTS_FILE_RESNETEIGHTEEN_HASH
...
MODEL_WEIGHTS_FILE_RESNETEIGHTEEN_URL=https://huggingface.co/TencentMedicalNet/MedicalNet-Resnet10/resolve/9d7c4c66c77bff89b79631369426612f09d0fe9b/resnet_18_23dataset.pth   # specific commit ID, not main
...
MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_HASH=3ea7188e396774e4ef95b66e5e90a78273bb33f6e58d3d717bf24f5f1aaeaa28
MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_MAIN_CONTENTS=88ab6700282025f59006c121d60a365c9ae6ba84
MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet34/blobs/'$MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_HASH
MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_SYMLINK=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet34/snapshots/'$MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_MAIN_CONTENTS'/resnet_34_23dataset.pth'
MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_URL='https://huggingface.co/TencentMedicalNet/MedicalNet-Resnet34/resolve/'$MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_MAIN_CONTENTS'/resnet_34_23dataset.pth'
MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_MAIN_FILE=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet34/refs/main'

MODEL_WEIGHTS_FILE_RESNETFIFTY_HASH=ff48a62219073fb977fd3f4ddfb8dc1367f0ec156c8d6f6c37e205bd683a246e
MODEL_WEIGHTS_FILE_RESNETFIFTY_MAIN_CONTENTS=8d924de10880fc392b71cbf61804e880aeb74e53
MODEL_WEIGHTS_FILE_RESNETFIFTY=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet50/blobs/'$MODEL_WEIGHTS_FILE_RESNETFIFTY_HASH
MODEL_WEIGHTS_FILE_RESNETFIFTY_SYMLINK=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet50/snapshots/'$MODEL_WEIGHTS_FILE_RESNETFIFTY_MAIN_CONTENTS'/resnet_50_23dataset.pth'
MODEL_WEIGHTS_FILE_RESNETFIFTY_URL='https://huggingface.co/TencentMedicalNet/MedicalNet-Resnet50/resolve/'$MODEL_WEIGHTS_FILE_RESNETFIFTY_MAIN_CONTENTS'/resnet_50_23dataset.pth'
MODEL_WEIGHTS_FILE_RESNETFIFTY_MAIN_FILE=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet50/refs/main'

MODEL_WEIGHTS_FILE_RESNETONEOHONE_HASH=a26bbcf9b2ad35f048b0fa317234c003f171a4d719760e5c4aff9f793654ebcf
MODEL_WEIGHTS_FILE_RESNETONEOHONE_MAIN_CONTENTS=2ea2545f9c234bfcff474b593df819e000c438c8
MODEL_WEIGHTS_FILE_RESNETONEOHONE=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet101/blobs/'$MODEL_WEIGHTS_FILE_RESNETONEOHONE_HASH
MODEL_WEIGHTS_FILE_RESNETONEOHONE_SYMLINK=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet101/snapshots/'$MODEL_WEIGHTS_FILE_RESNETONEOHONE_MAIN_CONTENTS'/resnet_101_23dataset.pth'
MODEL_WEIGHTS_FILE_RESNETONEOHONE_URL='https://huggingface.co/TencentMedicalNet/MedicalNet-Resnet101/resolve/7609a48246ec6bdd4ed2d2ad4f48fac05978ba67/resnet_101.pth'   # specific commit ID, not main
MODEL_WEIGHTS_FILE_RESNETONEOHONE_MAIN_FILE=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet101/refs/main'

MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_HASH=e96c459f5317ef2cbb898c91575402da2c78b31a31f55c5d28943683fe0626da
MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_MAIN_CONTENTS=ee78d896acdd5dbbd3cb6402a9a72e1f69a41188
MODEL_WEIGHTS_FILE_RESNETONEFIVETWO=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet152/blobs/'$MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_HASH
MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_SYMLINK=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet152/snapshots/'$MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_MAIN_CONTENTS'/resnet_152_23dataset.pth'
MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_URL='https://huggingface.co/TencentMedicalNet/MedicalNet-Resnet152/resolve/a040da51a0d8e8b3dc38aa0cb3dc7c445aa29ca9/resnet_152.pth'   # specific commit ID, not main
MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_MAIN_FILE=$CACHE_DIR'/hf_home_cache/hub/models--TencentMedicalNet--MedicalNet-Resnet152/refs/main'
...
_cache_file_resnet () {
    ...
    MODEL_WEIGHTS_FILE_MAIN_FILE=$4
    MODEL_WEIGHTS_FILE_MAIN_CONTENTS=$5

    _cache_file_wget "$MODEL_WEIGHTS_FILE_URL" "$MODEL_WEIGHTS_FILE"
    if [[ ! -f "$MODEL_WEIGHTS_FILE_SYMLINK" ]]; then
        mkdir -p $(dirname $MODEL_WEIGHTS_FILE_SYMLINK)
        cd $(dirname $MODEL_WEIGHTS_FILE_SYMLINK)
        ln -s -f ../../blobs/$(basename $MODEL_WEIGHTS_FILE) $(basename $MODEL_WEIGHTS_FILE_SYMLINK)
    fi
    if [[ ! -f "$MODEL_WEIGHTS_FILE_MAIN_FILE" ]]; then
        mkdir -p $(dirname $MODEL_WEIGHTS_FILE_MAIN_FILE)
        echo $MODEL_WEIGHTS_FILE_MAIN_CONTENTS > $MODEL_WEIGHTS_FILE_MAIN_FILE
    fi
...
cache_files () {
    ...
    _cache_file_resnet "$MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_URL" "$MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR" "$MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_SYMLINK" "$MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_MAIN_FILE" "$MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_MAIN_CONTENTS"
    _cache_file_resnet "$MODEL_WEIGHTS_FILE_RESNETFIFTY_URL" "$MODEL_WEIGHTS_FILE_RESNETFIFTY" "$MODEL_WEIGHTS_FILE_RESNETFIFTY_SYMLINK" "$MODEL_WEIGHTS_FILE_RESNETFIFTY_MAIN_FILE" "$MODEL_WEIGHTS_FILE_RESNETFIFTY_MAIN_CONTENTS"
    _cache_file_resnet "$MODEL_WEIGHTS_FILE_RESNETONEOHONE_URL" "$MODEL_WEIGHTS_FILE_RESNETONEOHONE" "$MODEL_WEIGHTS_FILE_RESNETONEOHONE_SYMLINK" "$MODEL_WEIGHTS_FILE_RESNETONEOHONE_MAIN_FILE" "$MODEL_WEIGHTS_FILE_RESNETONEOHONE_MAIN_CONTENTS"
    _cache_file_resnet "$MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_URL" "$MODEL_WEIGHTS_FILE_RESNETONEFIVETWO" "$MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_SYMLINK" "$MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_MAIN_FILE" "$MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_MAIN_CONTENTS"
}
...
verify_files () {
    ...
    _verify_hash $MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR_HASH $MODEL_WEIGHTS_FILE_RESNETTHIRTYFOUR
    _verify_hash $MODEL_WEIGHTS_FILE_RESNETFIFTY_HASH $MODEL_WEIGHTS_FILE_RESNETFIFTY
    _verify_hash $MODEL_WEIGHTS_FILE_RESNETONEOHONE_HASH $MODEL_WEIGHTS_FILE_RESNETONEOHONE
    _verify_hash $MODEL_WEIGHTS_FILE_RESNETONEFIVETWO_HASH $MODEL_WEIGHTS_FILE_RESNETONEFIVETWO
    if [[ -f "$MODEL_WEIGHTS_FILE_SAMMED2D" ]]; then
        _verify_hash $MODEL_WEIGHTS_FILE_SAMMED2D_HASH $MODEL_WEIGHTS_FILE_SAMMED2D
    fi
}

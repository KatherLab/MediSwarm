...
class ConvergenceResults:
    ...
    def get_class_statistics(self, epoch: int = 0) -> Dict[int, float]:
    ...
    def get_auc_roc_values(self) -> Dict[int, float]:
        def _compute_auc_roc(data: List[GT_Classprob]) -> float:
            ...
            # ovo micro not implemented in sklearn.metrics.roc_auc_score
        ...
        for epoch, data in self.gt_classprob_for_epoch.items():
...
if __name__ == '__main__':
    ...
    roc_auc_values = convergence_results.get_auc_roc_values()

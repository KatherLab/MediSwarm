...
cp ./application/jobs/ODELIA_ternary_classification/app/custom/models/challenge/* $CLEAN_SOURCE_DIR/MediSwarm/application/jobs/ODELIA_ternary_classification/app/custom/models/challenge/*

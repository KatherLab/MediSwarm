...
LATEST_DOCKER_VERSION="5fe6c0b"
DOCKER_DIR="${PROJECT_ROOT}/workspace/odelia_challenge_test_1.0.2-dev.260319.${LATEST_DOCKER_VERSION}_model_test/prod_00/UKA_1/startup/" 
...
NO_PUSH=false
SKIP_BUILD=true
MODELS_TO_TEST="1DivideAndConquer,3agaldran"  # "1DivideAndConquer,2BCN_AIM,3agaldran,4LME_ABMIL,5Pimed"
